...
public class CardLayoutUscita{
	...
	private void displayGUI() {
      ...
      //vedi più in basso. In sintesi, creo 3 JPanel "speciali" (create a piacere)
        ...
        ChoiceButtonPanel panel3 = new ChoiceButtonPanel("Seleziona metodo di pagamento",this);
        ...
        Panel[] panelArray = {panel1,panel2,panel3};
        panels = panelArray;
...
class ButtonPanel extends Panel{
	...
	public ButtonPanel(String labelText, CardLayoutUscita clu) {
		...
		JButton jcomp1 = new JButton ("PREMI");
...
class ChoiceButtonPanel extends Panel {
	
	private String choice;
	
	public ChoiceButtonPanel( String labelText, CardLayoutUscita clu ) {
		super(labelText);
		
		JButton jcomp1 = new JButton("contanti");
		JButton jcomp2 = new JButton("carta di credito");
		JButton jcomp3 = new JButton("annulla");
