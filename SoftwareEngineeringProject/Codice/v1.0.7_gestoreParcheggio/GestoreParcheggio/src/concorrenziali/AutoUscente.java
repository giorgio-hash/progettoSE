...
public class AutoUscente implements Runnable
{
	...
	public static final int PORT = Integer.parseInt(getTCPSocket()); 
   ...
   public AutoUscente(GestoreParcheggio b) throws IOException {
      buffer = b;
   ...
   public void run(){
	  ...
	  // chiusura di stream e socket
   	...
   	private static String getTCPSocket() {
		
		FileInputManager file = new FileInputManager("srcIPs.txt");
		
		String str = file.readLine();
		while( str != null ) { 
					if( str.contains("uscente:") )
